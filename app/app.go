...
func (app *App) InitRouter() {
	...
	// TODO: Secure the API: consider JWT verification vs host request restriction.
	// Handle routes in subrouters along the two primary resource paths.
	app.Router.Handle("/", ApiInfo())
